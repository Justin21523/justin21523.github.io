...
const EXCLUDED_FOLDERS = [
  ...
  "Justin21523", // GitHub profile README repo, not a portfolio project
  ...
  "intro-to-vml-practice",
  "intro-to-ml-practice",
  "intro-to-dl-practice",
  "T2I-practice-lab",
  "Ragent-text-lab",
  "LLM-practice-lab",
...
const EXCLUDED_PROJECT_PATHS = new Set([
  ...
  path.join(HOME_DIR, "web-projects", "Justin21523"),
  ...
  path.join(HOME_DIR, "web-projects", "lost-campus-rpg"),
  path.join(HOME_DIR, "web-projects", "mission-based-rpg"),
  path.join(HOME_DIR, "web-projects", "flying-mission-rpg"),
  path.join(HOME_DIR, "web-projects", "video-gen"),
  path.join(HOME_DIR, "web-projects", "video-family-lora-hub"),
  path.join(HOME_DIR, "web-projects", "intro-to-vml-practice"),
  path.join(HOME_DIR, "web-projects", "intro-to-ml-practice"),
  path.join(HOME_DIR, "web-projects", "intro-to-dl-practice"),
  path.join(HOME_DIR, "web-projects", "T2I-practice-lab"),
  path.join(HOME_DIR, "web-projects", "Ragent-text-lab"),
  path.join(HOME_DIR, "web-projects", "LLM-practice-lab"),
  path.join(HOME_DIR, "web-projects", "linear-algebra-practice"),
  path.join(HOME_DIR, "web-projects", "DM2024-Lab2-Homework"),
  path.join(HOME_DIR, "web-projects", "DM2024-Lab1-Master"),
  path.join(HOME_DIR, "web-projects", "DM2024-Lab1-Homework"),
  path.join(HOME_DIR, "web-projects", "data-structure-practice"),
  path.join(HOME_DIR, "web-projects", "csharp-learning-desktop-unity"),
  path.join(HOME_DIR, "web-projects", "computer-organization-practice"),
  path.join(HOME_DIR, "web-projects", "algorithm-practice"),
  path.join(WINDOWS_PROJECT_ROOT, "justin-portfolio"),
  path.join(WINDOWS_PROJECT_ROOT, "justin21523.github.io"),
  path.join(WINDOWS_PROJECT_ROOT, "Justin21523"),
]);
