# SD Multi-Modal Platform: Portfolio-Ready Stable Diffusion Platform Demo Recording Guide
...
## Recording Flow
1. Open the portfolio case study at `/projects/sd-multimodal-platform`.
