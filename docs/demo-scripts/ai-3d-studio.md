# AI 3D Studio — A Unified Multi-Backend Image-to-3D Generation and Blender Integration Framework Demo Recording Guide
...
## Recording Flow
1. Open the portfolio case study at `/projects/ai-3d-studio`.
