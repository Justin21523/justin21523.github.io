# CharaForge T2I Lab — Text-to-Image, ControlNet, and LoRA Training Platform Demo Recording Guide

## Current Media Status
- Screenshots: real screenshots present; captured 4 new
- Demo video: real video present
- Live demo / deployment: external live demo link present

## Recommended Length
45-90 seconds.

## Recording Flow
1. Open the portfolio case study at `/projects/charaforge-T2I-Lab`.
...
- Real screenshots are already present; replace only if the UI changes.
