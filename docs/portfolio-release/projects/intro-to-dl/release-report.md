# Deep Learning Hands-On Tutorial Series Release Report

## Completed
- Portfolio case study exists for `intro-to-dl`.
...
## Changed Files
- `docs/portfolio-release/projects/intro-to-dl/audit.md`
- `docs/portfolio-release/projects/intro-to-dl/release-report.md`
- `docs/demo-scripts/intro-to-dl.md`
- `public/projects/intro-to-dl/`

## Links
- Portfolio Case Study: /projects/intro-to-dl
- GitHub: https://github.com/Justin21523/intro-to-dl-practice
- README: https://github.com/Justin21523/intro-to-dl-practice#readme
- Live Demo: https://justin21523.github.io/intro-to-dl/
- Demo Video: /projects/intro-to-dl#demo-video
...
## Assets
- Hero image: public/projects/intro-to-dl/hero.png
- Screenshots: public/projects/intro-to-dl/screenshots/
- Demo video: manual recording guide
- Diagrams: public/projects/intro-to-dl/diagrams/
