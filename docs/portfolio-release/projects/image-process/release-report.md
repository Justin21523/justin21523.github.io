# Browser-Based 3D Model Viewer & Editor Release Report

## Completed
- Portfolio case study exists for `image-process`.
...
## Changed Files
- `docs/portfolio-release/projects/image-process/audit.md`
- `docs/portfolio-release/projects/image-process/release-report.md`
- `docs/demo-scripts/image-process.md`
- `public/projects/image-process/`

## Links
- Portfolio Case Study: /projects/image-process
- GitHub: /projects/image-process#source-access
- README: /projects/image-process#readme-guide
- Live Demo: https://justin21523.github.io/image-process/
- Demo Video: /projects/image-process#demo-video
...
## Assets
- Hero image: public/projects/image-process/hero.png
- Screenshots: public/projects/image-process/screenshots/
- Demo video: manual recording guide
- Diagrams: public/projects/image-process/diagrams/
