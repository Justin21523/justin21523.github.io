# DataAgent Analyst: AI Agent Data Analysis & ML Workbench Audit

| Field | Value |
| :--- | :--- |
| Portfolio slug | `dataagent-analyst` |
| Matched GitHub repo | https://github.com/Justin21523/dataagent-analyst |
| Matched local path | Stored in `.portfolio-local-map.json` |
| Match confidence | high |
| Match status | matched |
| Tech stack | FastAPI, Python 3.12, scikit-learn, LangGraph, llama.cpp, pandas, SHAP, Vanilla JavaScript, Docker Compose, Apache ECharts |
...
| Portfolio detail page | /projects/dataagent-analyst |
...
## Recommended Fixes
- Replace generated placeholders under `public/projects/dataagent-analyst/` with real screenshots when possible.
