# News Web Crawler & Data Intelligence Platform Release Report

## Completed
- Portfolio case study exists for `news-web-crawler`.
...
## Changed Files
- `docs/portfolio-release/projects/news-web-crawler/audit.md`
- `docs/portfolio-release/projects/news-web-crawler/release-report.md`
- `docs/demo-scripts/news-web-crawler.md`
- `public/projects/news-web-crawler/`

## Links
- Portfolio Case Study: /projects/news-web-crawler
- GitHub: https://github.com/Justin21523/news-web-crawler
- README: https://github.com/Justin21523/news-web-crawler#readme
- Live Demo: /projects/news-web-crawler#demo-guide
- Demo Video: /portfolio/projects/news-web-crawler/demo/guided-tour.webm
...
## Assets
- Hero image: public/projects/news-web-crawler/hero.png
- Screenshots: public/projects/news-web-crawler/screenshots/
- Demo video: existing media linked
- Diagrams: public/projects/news-web-crawler/diagrams/
