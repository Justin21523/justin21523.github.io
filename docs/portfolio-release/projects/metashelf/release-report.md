# MetaShelf — Bibliographic Resource Discovery Platform Release Report

## Completed
- Portfolio case study exists for `metashelf`.
...
## Changed Files
- `docs/portfolio-release/projects/metashelf/audit.md`
- `docs/portfolio-release/projects/metashelf/release-report.md`
- `docs/demo-scripts/metashelf.md`
- `public/projects/metashelf/`

## Links
- Portfolio Case Study: /projects/metashelf
- GitHub: /projects/metashelf#source-access
- README: /projects/metashelf#readme-guide
- Live Demo: https://justin21523.github.io/metashelf/
- Demo Video: /projects/metashelf#demo-video
...
## Assets
- Hero image: public/projects/metashelf/hero.png
- Screenshots: public/projects/metashelf/screenshots/
- Demo video: manual recording guide
- Diagrams: public/projects/metashelf/diagrams/
