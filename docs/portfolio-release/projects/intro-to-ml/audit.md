# Intro to ML: Classical Machine Learning From Scratch Audit

| Field | Value |
| :--- | :--- |
| Portfolio slug | `intro-to-ml` |
| Matched GitHub repo | https://github.com/Justin21523/intro-to-ml-practice |
| Matched local path | Stored in `.portfolio-local-map.json` |
| Match confidence | high |
| Match status | matched |
| Tech stack | Python, NumPy, Matplotlib, SciPy, scikit-learn (datasets only), Jupyter Notebook, Docker, Nginx |
...
| Portfolio detail page | /projects/intro-to-ml |
...
## Recommended Fixes
- Replace generated placeholders under `public/projects/intro-to-ml/` with real screenshots when possible.
