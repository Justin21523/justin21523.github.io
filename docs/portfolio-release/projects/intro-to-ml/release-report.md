# Intro to ML: Classical Machine Learning From Scratch Release Report

## Completed
- Portfolio case study exists for `intro-to-ml`.
...
## Changed Files
- `docs/portfolio-release/projects/intro-to-ml/audit.md`
- `docs/portfolio-release/projects/intro-to-ml/release-report.md`
- `docs/demo-scripts/intro-to-ml.md`
- `public/projects/intro-to-ml/`

## Links
- Portfolio Case Study: /projects/intro-to-ml
- GitHub: https://github.com/Justin21523/intro-to-ml-practice
- README: https://github.com/Justin21523/intro-to-ml-practice#readme
- Live Demo: https://justin21523.github.io/intro-to-ml/
- Demo Video: /projects/intro-to-ml#demo-video
...
## Assets
- Hero image: public/projects/intro-to-ml/hero.png
- Screenshots: public/projects/intro-to-ml/screenshots/
- Demo video: manual recording guide
- Diagrams: public/projects/intro-to-ml/diagrams/
