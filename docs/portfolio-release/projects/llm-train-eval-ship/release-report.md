# LLM Train-Eval-Ship Release Console Release Report

## Completed
- Portfolio case study exists for `llm-train-eval-ship`.
...
## Changed Files
- `docs/portfolio-release/projects/llm-train-eval-ship/audit.md`
- `docs/portfolio-release/projects/llm-train-eval-ship/release-report.md`
- `docs/demo-scripts/llm-train-eval-ship.md`
- `public/projects/llm-train-eval-ship/`

## Links
- Portfolio Case Study: /projects/llm-train-eval-ship
- GitHub: https://github.com/Justin21523/LLM-train-eval-ship
- README: https://github.com/Justin21523/LLM-train-eval-ship#readme
- Live Demo: https://justin21523.github.io/LLM-train-eval-ship/
- Demo Video: /portfolio/projects/llm-train-eval-ship/demo/guided-demo.webm
...
## Assets
- Hero image: public/projects/llm-train-eval-ship/hero.png
- Screenshots: public/projects/llm-train-eval-ship/screenshots/
- Demo video: existing media linked
- Diagrams: public/projects/llm-train-eval-ship/diagrams/
