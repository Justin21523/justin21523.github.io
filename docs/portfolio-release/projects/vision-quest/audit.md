# VisionQuest Multi-Modal AI Platform Audit

| Field | Value |
| :--- | :--- |
| Portfolio slug | `vision-quest` |
| Matched GitHub repo | https://github.com/Justin21523/vision-quest |
| Matched local path | Stored in `.portfolio-local-map.json` |
| Match confidence | high |
| Match status | matched |
| Tech stack | FastAPI, Python, PyTorch, Transformers, LangChain, React, TypeScript, PostgreSQL / pgvector, Docker |
...
| Portfolio detail page | /projects/vision-quest |
...
## Recommended Fixes
- Replace generated placeholders under `public/projects/vision-quest/` with real screenshots when possible.
