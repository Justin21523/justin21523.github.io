# CulturePOS Cultural-Retail POS Desktop System Release Report

## Completed
- Portfolio case study exists for `CulturePOS`.
...
## Changed Files
- `docs/portfolio-release/projects/CulturePOS/audit.md`
- `docs/portfolio-release/projects/CulturePOS/release-report.md`
- `docs/demo-scripts/CulturePOS.md`
- `public/projects/CulturePOS/`

## Links
- Portfolio Case Study: /projects/CulturePOS
- GitHub: /projects/CulturePOS#source-access
- README: /projects/CulturePOS#readme-guide
- Live Demo: https://justin21523.github.io/CulturePOS/
- Demo Video: /projects/CulturePOS#demo-video
...
## Assets
- Hero image: public/projects/CulturePOS/hero.png
- Screenshots: public/projects/CulturePOS/screenshots/
- Demo video: manual recording guide
- Diagrams: public/projects/CulturePOS/diagrams/
