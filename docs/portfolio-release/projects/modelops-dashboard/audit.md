# Modelops Dashboard Audit

| Field | Value |
| :--- | :--- |
| Portfolio slug | `modelops-dashboard` |
| Matched GitHub repo | https://github.com/Justin21523/modelops-dashboard |
| Matched local path | Stored in `.portfolio-local-map.json` |
| Match confidence | high |
| Match status | matched |
| Tech stack | Java, Maven, Spring Boot |
| Framework / language | Java/Maven |
...
| Portfolio detail page | /projects/modelops-dashboard |
...
## Recommended Fixes
- Replace generated placeholders under `public/projects/modelops-dashboard/` with real screenshots when possible.
