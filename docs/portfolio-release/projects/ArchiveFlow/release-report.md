# ArchiveFlow Studio Release Report

## Completed
- Portfolio case study exists for `ArchiveFlow`.
...
## Changed Files
- `docs/portfolio-release/projects/ArchiveFlow/audit.md`
- `docs/portfolio-release/projects/ArchiveFlow/release-report.md`
- `docs/demo-scripts/ArchiveFlow.md`
- `public/projects/ArchiveFlow/`

## Links
- Portfolio Case Study: /projects/ArchiveFlow
- GitHub: https://github.com/Justin21523/archive-flow-studio
...
## Assets
- Hero image: public/projects/ArchiveFlow/hero.png
- Screenshots: public/projects/ArchiveFlow/screenshots/
- Demo video: manual recording guide
- Diagrams: public/projects/ArchiveFlow/diagrams/
