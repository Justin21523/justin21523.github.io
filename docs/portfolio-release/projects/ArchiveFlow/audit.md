# ArchiveFlow Studio Audit

| Field | Value |
| :--- | :--- |
| Portfolio slug | `ArchiveFlow` |
| Matched GitHub repo | https://github.com/Justin21523/archive-flow-studio |
| Matched local path | Stored in `.portfolio-local-map.json` |
| Match confidence | high |
| Match status | matched |
| Tech stack | C#, .NET, Avalonia, SQLite, Dapper, FluentMigrator, ImageSharp, MVVM, Clean Architecture |
...
| Portfolio detail page | /projects/ArchiveFlow |
...
## Recommended Fixes
- Replace generated placeholders under `public/projects/ArchiveFlow/` with real screenshots when possible.
