# RestorAI Studio — AI Image Restoration Portfolio Workbench Audit

| Field | Value |
| :--- | :--- |
| Portfolio slug | `restoreAI-studio` |
| Matched GitHub repo | https://github.com/Justin21523/restoreAI-studio |
| Matched local path | Stored in `.portfolio-local-map.json` |
| Match confidence | high |
| Match status | matched |
| Tech stack | Python, FastAPI, Pillow, JavaScript, Canvas, Playwright, PyTorch, Real-ESRGAN, GFPGAN, RIFE, Gradio, PyQt, GitHub Pages, Docker |
...
| Portfolio detail page | /projects/restoreAI-studio |
...
## Recommended Fixes
- Replace generated placeholders under `public/projects/restoreAI-studio/` with real screenshots when possible.
