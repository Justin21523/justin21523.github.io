# RestorAI Studio — AI Image Restoration Portfolio Workbench Release Report

## Completed
- Portfolio case study exists for `restoreAI-studio`.
...
## Changed Files
- `docs/portfolio-release/projects/restoreAI-studio/audit.md`
- `docs/portfolio-release/projects/restoreAI-studio/release-report.md`
- `docs/demo-scripts/restoreAI-studio.md`
- `public/projects/restoreAI-studio/`

## Links
- Portfolio Case Study: /projects/restoreAI-studio
- GitHub: https://github.com/Justin21523/restoreAI-studio
- README: https://github.com/Justin21523/restoreAI-studio#readme
- Live Demo: https://justin21523.github.io/restoreAI-studio/
- Demo Video: /portfolio/projects/restoreAI-studio/demo/demo-tour.webm
...
## Assets
- Hero image: public/projects/restoreAI-studio/hero.png
- Screenshots: public/projects/restoreAI-studio/screenshots/
- Demo video: existing media linked
- Diagrams: public/projects/restoreAI-studio/diagrams/
