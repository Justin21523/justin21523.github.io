# GeoVideo Evidence Viewer Release Report

## Completed
- Portfolio case study exists for `geovideo-env-check`.
...
## Changed Files
- `docs/portfolio-release/projects/geovideo-env-check/audit.md`
- `docs/portfolio-release/projects/geovideo-env-check/release-report.md`
- `docs/demo-scripts/geovideo-env-check.md`
- `public/projects/geovideo-env-check/`

## Links
- Portfolio Case Study: /projects/geovideo-env-check
- GitHub: /projects/geovideo-env-check#source-access
- README: /projects/geovideo-env-check#readme-guide
- Live Demo: https://justin21523.github.io/geovideo-env-check/
- Demo Video: /projects/geovideo-env-check#demo-video
...
## Assets
- Hero image: public/projects/geovideo-env-check/hero.png
- Screenshots: public/projects/geovideo-env-check/screenshots/
- Demo video: manual recording guide
- Diagrams: public/projects/geovideo-env-check/diagrams/
