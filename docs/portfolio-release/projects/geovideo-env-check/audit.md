# GeoVideo Evidence Viewer Audit

| Field | Value |
| :--- | :--- |
| Portfolio slug | `geovideo-env-check` |
| Matched GitHub repo | /projects/geovideo-env-check#source-access |
| Matched local path | Stored in `.portfolio-local-map.json` |
| Match confidence | high |
| Match status | missing-github-repo |
| Tech stack | C++20, Qt6, Qt6 Widgets, Qt6 Multimedia, Qt6 OpenGLWidgets, OpenCV, SQLite, CMake, Ninja, clangd |
...
| Portfolio detail page | /projects/geovideo-env-check |
...
## Recommended Fixes
- Replace generated placeholders under `public/projects/geovideo-env-check/` with real screenshots when possible.
