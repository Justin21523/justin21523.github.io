# Intro to VML: Visual Machine Learning Primer Release Report

## Completed
- Portfolio case study exists for `intro-to-vml`.
...
## Changed Files
- `docs/portfolio-release/projects/intro-to-vml/audit.md`
- `docs/portfolio-release/projects/intro-to-vml/release-report.md`
- `docs/demo-scripts/intro-to-vml.md`
- `public/projects/intro-to-vml/`

## Links
- Portfolio Case Study: /projects/intro-to-vml
- GitHub: https://github.com/Justin21523/intro-to-vml-practice
- README: https://github.com/Justin21523/intro-to-vml-practice#readme
- Live Demo: https://justin21523.github.io/intro-to-vml/
- Demo Video: /projects/intro-to-vml#demo-video
...
## Assets
- Hero image: public/projects/intro-to-vml/hero.png
- Screenshots: public/projects/intro-to-vml/screenshots/
- Demo video: manual recording guide
- Diagrams: public/projects/intro-to-vml/diagrams/
