# TripScore: Explainable Destination Scoring & Recommendation Release Report

## Completed
- Portfolio case study exists for `tripscore`.
...
## Changed Files
- `docs/portfolio-release/projects/tripscore/audit.md`
- `docs/portfolio-release/projects/tripscore/release-report.md`
- `docs/demo-scripts/tripscore.md`
- `public/projects/tripscore/`

## Links
- Portfolio Case Study: /projects/tripscore
- GitHub: https://github.com/Justin21523/tripscore
- README: https://github.com/Justin21523/tripscore#readme
- Live Demo: https://justin21523.github.io/tripscore/
- Demo Video: /projects/tripscore#demo-video
...
## Assets
- Hero image: public/projects/tripscore/hero.png
- Screenshots: public/projects/tripscore/screenshots/
- Demo video: manual recording guide
- Diagrams: public/projects/tripscore/diagrams/
