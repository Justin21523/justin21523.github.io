# TripScore: Explainable Destination Scoring & Recommendation Audit

| Field | Value |
| :--- | :--- |
| Portfolio slug | `tripscore` |
| Matched GitHub repo | https://github.com/Justin21523/tripscore |
| Matched local path | Stored in `.portfolio-local-map.json` |
| Match confidence | high |
| Match status | matched |
| Tech stack | Python, FastAPI, Pydantic, Jinja2, httpx, Leaflet, Docker, pytest, TDX API, Open-Meteo |
...
| Portfolio detail page | /projects/tripscore |
...
## Recommended Fixes
- Replace generated placeholders under `public/projects/tripscore/` with real screenshots when possible.
