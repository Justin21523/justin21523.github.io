# GovCase Tracker — Government Case Tracking System Release Report

## Completed
- Portfolio case study exists for `govcase-tracker`.
...
## Changed Files
- `docs/portfolio-release/projects/govcase-tracker/audit.md`
- `docs/portfolio-release/projects/govcase-tracker/release-report.md`
- `docs/demo-scripts/govcase-tracker.md`
- `public/projects/govcase-tracker/`

## Links
- Portfolio Case Study: /projects/govcase-tracker
- GitHub: /projects/govcase-tracker#source-access
- README: /projects/govcase-tracker#readme-guide
- Live Demo: https://justin21523.github.io/govcase-tracker/
- Demo Video: /projects/govcase-tracker#demo-video
...
## Assets
- Hero image: public/projects/govcase-tracker/hero.png
- Screenshots: public/projects/govcase-tracker/screenshots/
- Demo video: manual recording guide
- Diagrams: public/projects/govcase-tracker/diagrams/
