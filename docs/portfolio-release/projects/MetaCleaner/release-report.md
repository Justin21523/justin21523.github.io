# MetaCleaner Batch Metadata Scrubbing Tool Release Report

## Completed
- Portfolio case study exists for `MetaCleaner`.
...
## Changed Files
- `docs/portfolio-release/projects/MetaCleaner/audit.md`
- `docs/portfolio-release/projects/MetaCleaner/release-report.md`
- `docs/demo-scripts/MetaCleaner.md`
- `public/projects/MetaCleaner/`

## Links
- Portfolio Case Study: /projects/MetaCleaner
- GitHub: /projects/MetaCleaner#source-access
- README: /projects/MetaCleaner#readme-guide
- Live Demo: https://justin21523.github.io/MetaCleaner/
- Demo Video: /projects/MetaCleaner#demo-video
...
## Assets
- Hero image: public/projects/MetaCleaner/hero.png
- Screenshots: public/projects/MetaCleaner/screenshots/
- Demo video: manual recording guide
- Diagrams: public/projects/MetaCleaner/diagrams/
