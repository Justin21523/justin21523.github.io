# Commercial ML Analysis Platform Audit

| Field | Value |
| :--- | :--- |
| Portfolio slug | `commercial-ml-analysis` |
| Matched GitHub repo | https://github.com/Justin21523/commercial-ml-analysis |
| Matched local path | Stored in `.portfolio-local-map.json` |
| Match confidence | high |
| Match status | matched |
| Tech stack | Python, Polars, LightGBM, CatBoost, Optuna, MLflow, Evidently AI, Prefect, ONNX Runtime, React |
...
| Portfolio detail page | /projects/commercial-ml-analysis |
...
## Recommended Fixes
- Replace generated placeholders under `public/projects/commercial-ml-analysis/` with real screenshots when possible.
