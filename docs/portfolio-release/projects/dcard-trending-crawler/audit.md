# posts-trending-crawler Audit

| Field | Value |
| :--- | :--- |
| Portfolio slug | `dcard-trending-crawler` |
| Matched GitHub repo | https://github.com/Justin21523/posts-trending-crawler |
...
| Portfolio detail page | /projects/dcard-trending-crawler |
...
## Recommended Fixes
- Replace generated placeholders under `public/projects/dcard-trending-crawler/` with real screenshots when possible.
