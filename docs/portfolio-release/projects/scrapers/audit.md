...
| Field | Value |
| :--- | :--- |
| Portfolio slug | `scrapers` |
| Matched GitHub repo | /projects/scrapers#source-access |
...
| Portfolio detail page | /projects/scrapers |
...
## Recommended Fixes
- Replace generated placeholders under `public/projects/scrapers/` with real screenshots when possible.
