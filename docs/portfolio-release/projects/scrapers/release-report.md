# Scrapers Release Report

## Completed
- Portfolio case study exists for `scrapers`.
...
## Changed Files
- `docs/portfolio-release/projects/scrapers/audit.md`
- `docs/portfolio-release/projects/scrapers/release-report.md`
- `docs/demo-scripts/scrapers.md`
- `public/projects/scrapers/`

## Links
- Portfolio Case Study: /projects/scrapers
- GitHub: /projects/scrapers#source-access
- README: /projects/scrapers#readme-guide
- Live Demo: https://justin21523.github.io/scrapers/
- Demo Video: /projects/scrapers#demo-video
...
## Assets
- Hero image: public/projects/scrapers/hero.png
- Screenshots: public/projects/scrapers/screenshots/
- Demo video: manual recording guide
- Diagrams: public/projects/scrapers/diagrams/
