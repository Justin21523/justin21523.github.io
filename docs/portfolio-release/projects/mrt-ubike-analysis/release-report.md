# MetroBikeAtlas: Metro & Shared-Bike Urban Mobility Analytics Release Report

## Completed
- Portfolio case study exists for `mrt-ubike-analysis`.
...
## Changed Files
- `docs/portfolio-release/projects/mrt-ubike-analysis/audit.md`
- `docs/portfolio-release/projects/mrt-ubike-analysis/release-report.md`
- `docs/demo-scripts/mrt-ubike-analysis.md`
- `public/projects/mrt-ubike-analysis/`

## Links
- Portfolio Case Study: /projects/mrt-ubike-analysis
- GitHub: https://github.com/Justin21523/mrt-ubike-analysis
- README: https://github.com/Justin21523/mrt-ubike-analysis#readme
- Live Demo: https://justin21523.github.io/mrt-ubike-analysis/
- Demo Video: /projects/mrt-ubike-analysis#demo-video
...
## Assets
- Hero image: public/projects/mrt-ubike-analysis/hero.png
- Screenshots: public/projects/mrt-ubike-analysis/screenshots/
- Demo video: manual recording guide
- Diagrams: public/projects/mrt-ubike-analysis/diagrams/
