# MetroBikeAtlas: Metro & Shared-Bike Urban Mobility Analytics Audit

| Field | Value |
| :--- | :--- |
| Portfolio slug | `mrt-ubike-analysis` |
| Matched GitHub repo | https://github.com/Justin21523/mrt-ubike-analysis |
| Matched local path | Stored in `.portfolio-local-map.json` |
| Match confidence | high |
| Match status | matched |
| Tech stack | Python, FastAPI, pandas, NumPy, Uvicorn, Leaflet, Chart.js, Docker, SQLite, Playwright |
...
| Portfolio detail page | /projects/mrt-ubike-analysis |
...
## Recommended Fixes
- Replace generated placeholders under `public/projects/mrt-ubike-analysis/` with real screenshots when possible.
