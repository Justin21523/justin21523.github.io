...
| Field | Value |
| :--- | :--- |
| Portfolio slug | `automation` |
| Matched GitHub repo | /projects/automation#source-access |
...
| Portfolio detail page | /projects/automation |
...
## Recommended Fixes
- Replace generated placeholders under `public/projects/automation/` with real screenshots when possible.
