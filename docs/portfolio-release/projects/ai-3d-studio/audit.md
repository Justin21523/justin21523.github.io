# AI 3D Studio — A Unified Multi-Backend Image-to-3D Generation and Blender Integration Framework Audit

| Field | Value |
| :--- | :--- |
| Portfolio slug | `ai-3d-studio` |
| Matched GitHub repo | https://github.com/Justin21523/ai-3d-studio |
| Matched local path | Stored in `.portfolio-local-map.json` |
| Match confidence | high |
| Match status | matched |
| Tech stack | Python, PyTorch, Pydantic v2, trimesh, rembg, xatlas, Blender (headless/bpy), ComfyUI, FastAPI, pytest |
...
| Portfolio detail page | /projects/ai-3d-studio |
...
## Recommended Fixes
- Replace generated placeholders under `public/projects/ai-3d-studio/` with real screenshots when possible.
