# RetailPulse BI & Recommendation Platform Audit

| Field | Value |
| :--- | :--- |
| Portfolio slug | `retailpulse-bi-recommender` |
| Matched GitHub repo | https://github.com/Justin21523/retailpulse-bi-recommender |
| Matched local path | Stored in `.portfolio-local-map.json` |
| Match confidence | high |
| Match status | matched |
| Tech stack | Python, FastAPI, DuckDB, scikit-learn, PyTorch, statsmodels, Next.js, TypeScript, Streamlit, Docker |
...
| Screenshots status | real media present |
| Demo status | portfolio case-study demo fallback |
| Portfolio detail page | /projects/retailpulse-bi-recommender |
...
## Recommended Fixes
- Replace generated placeholders under `public/projects/retailpulse-bi-recommender/` with real screenshots when possible.
