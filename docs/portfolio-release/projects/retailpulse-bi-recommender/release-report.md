# RetailPulse BI & Recommendation Platform Release Report

## Completed
- Portfolio case study exists for `retailpulse-bi-recommender`.
...
## Changed Files
- `docs/portfolio-release/projects/retailpulse-bi-recommender/audit.md`
- `docs/portfolio-release/projects/retailpulse-bi-recommender/release-report.md`
- `docs/demo-scripts/retailpulse-bi-recommender.md`
- `public/projects/retailpulse-bi-recommender/`

## Links
- Portfolio Case Study: /projects/retailpulse-bi-recommender
- GitHub: https://github.com/Justin21523/retailpulse-bi-recommender
- README: https://github.com/Justin21523/retailpulse-bi-recommender#portfolio-ui-demo-media
- Live Demo: /projects/retailpulse-bi-recommender#demo-guide
- Demo Video: /portfolio/projects/retailpulse-bi-recommender/demo/full-verification.webm
...
## Assets
- Hero image: public/projects/retailpulse-bi-recommender/hero.png
- Screenshots: public/projects/retailpulse-bi-recommender/screenshots/
- Demo video: existing media linked
- Diagrams: public/projects/retailpulse-bi-recommender/diagrams/
