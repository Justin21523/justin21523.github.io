# video-gen: ROCm Video-Gen Environment Governance Workspace Audit

| Field | Value |
| :--- | :--- |
| Portfolio slug | `video-gen` |
| Matched GitHub repo | https://github.com/Justin21523/video-gen |
| Matched local path | Stored in `.portfolio-local-map.json` |
| Match confidence | high |
| Match status | matched |
| Tech stack | Python 3.12, venv, pip, AMD ROCm, PyTorch (ROCm), ComfyUI (referenced), LTX-Video (referenced), OpenClaw agent framework, Markdown |
...
| Portfolio detail page | /projects/video-gen |
...
## Recommended Fixes
- Replace generated placeholders under `public/projects/video-gen/` with real screenshots when possible.
