# CafeNet Manager Release Report

## Completed
- Portfolio case study exists for `cafe-net-manager`.
...
## Changed Files
- `docs/portfolio-release/projects/cafe-net-manager/audit.md`
- `docs/portfolio-release/projects/cafe-net-manager/release-report.md`
- `docs/demo-scripts/cafe-net-manager.md`
- `public/projects/cafe-net-manager/`

## Links
- Portfolio Case Study: /projects/cafe-net-manager
- GitHub: https://github.com/Justin21523/cafe-net-manager
- README: https://github.com/Justin21523/cafe-net-manager#readme
- Live Demo: /projects/cafe-net-manager#demo-guide
- Demo Video: /projects/cafe-net-manager#demo-video
...
## Assets
- Hero image: public/projects/cafe-net-manager/hero.png
- Screenshots: public/projects/cafe-net-manager/screenshots/
- Demo video: manual recording guide
- Diagrams: public/projects/cafe-net-manager/diagrams/
