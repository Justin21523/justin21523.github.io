...
| Field | Value |
| :--- | :--- |
| Portfolio slug | `libradesk` |
| Matched GitHub repo | https://github.com/Justin21523/library-desk |
...
| Portfolio detail page | /projects/libradesk |
...
## Recommended Fixes
- Replace generated placeholders under `public/projects/libradesk/` with real screenshots when possible.
